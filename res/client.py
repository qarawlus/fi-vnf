...
Received: from paul-mail2.uni-paderborn.de ([131.234.157.142] helo=CN-AP02)\n\
	...
	id 1hdE01-0006yl-60\n\
	for qarawlus@mail.uni-paderborn.de; Tue, 18 Jun 2019 15:18:09 +0200\n\
MIME-Version: 1.0\n\
From: noreply@uni-paderborn.de\n\
To: qarawlus@mail.uni-paderborn.de\n\
...
X-Envelope-To: qarawlus@mail.uni-paderborn.de\n\
X-IMT-Authenticated-Sender: \n\
Hi, =0D=0A=0D=0Asmall reminder: tomorrow intermediate project pre=\n\
